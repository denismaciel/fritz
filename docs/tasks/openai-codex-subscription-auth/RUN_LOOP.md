# openai codex subscription auth run loop

Read `AGENTS.md`.

Read these pack files before coding:

- `docs/tasks/openai-codex-subscription-auth/INDEX.md`
- `docs/tasks/openai-codex-subscription-auth/STATUS.md`
- relevant ticket files under `docs/tasks/openai-codex-subscription-auth/`
...
- never leak OAuth tokens into logs, prompts, sessions, or docs
- keep Pi comparison anchored to the referenced source files in this pack
...
- if auth or transport behavior changes, add or update focused tests before moving on
