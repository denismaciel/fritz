# polish-stabilization run loop

Read `AGENTS.md`.

Read these pack files before coding:

- `docs/tasks/polish-stabilization/INDEX.md`
- `docs/tasks/polish-stabilization/STATUS.md`
- relevant ticket files under `docs/tasks/polish-stabilization/`
