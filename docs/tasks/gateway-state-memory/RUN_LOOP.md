# gateway state + memory run loop

Read `AGENTS.md`.

Read these pack files before coding:

- `docs/tasks/gateway-state-memory/INDEX.md`
- `docs/tasks/gateway-state-memory/STATUS.md`
- relevant ticket files under `docs/tasks/gateway-state-memory/`
...
- keep transcript state, gateway ops state, and durable memory as separate concerns
