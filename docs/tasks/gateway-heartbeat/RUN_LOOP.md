# gateway heartbeat run loop

Read `AGENTS.md`.

Read these pack files before coding:

- `docs/tasks/gateway-heartbeat/INDEX.md`
- `docs/tasks/gateway-heartbeat/STATUS.md`
- relevant ticket files under `docs/tasks/gateway-heartbeat/`
...
- keep scheduler logic in gateway code, not Telegram or engine internals
