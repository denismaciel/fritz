# embedded-memory-palace run loop

Read `AGENTS.md`.

Read these pack files before coding:

- `docs/tasks/embedded-memory-palace/INDEX.md`
- `docs/tasks/embedded-memory-palace/STATUS.md`
- relevant ticket files under `docs/tasks/embedded-memory-palace/`
...
- keep the promotable package Fritz-agnostic
- keep canonical store and retrieval concerns separate
- preserve existing durable-memory behavior while new indexing lands
