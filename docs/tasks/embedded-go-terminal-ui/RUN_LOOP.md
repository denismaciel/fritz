# embedded-go-terminal-ui run loop

Read `AGENTS.md`.

Read these pack files before coding:

- `docs/tasks/embedded-go-terminal-ui/INDEX.md`
- `docs/tasks/embedded-go-terminal-ui/STATUS.md`
- relevant ticket files under `docs/tasks/embedded-go-terminal-ui/`
...
- use a terminal view-model layer between agent events and Bubble Tea
