# memory-palace-sync run loop

Read `AGENTS.md`.

Read these pack files before coding:

- `docs/tasks/memory-palace-sync/INDEX.md`
- `docs/tasks/memory-palace-sync/STATUS.md`
- relevant ticket files under `docs/tasks/memory-palace-sync/`
...
- do not let embedding outages block canonical ingest
- keep session-event ingestion out unless the active ticket explicitly requires it
