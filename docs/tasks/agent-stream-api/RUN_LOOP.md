# agent-stream-api run loop

Read `AGENTS.md`.

Read these pack files before coding:

- `docs/tasks/agent-stream-api/INDEX.md`
- `docs/tasks/agent-stream-api/STATUS.md`
- relevant ticket files under `docs/tasks/agent-stream-api/`
...
- define one internal event model first; protocol adapters hang off it
